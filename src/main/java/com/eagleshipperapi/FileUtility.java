...
public class FileUtility {
	...
	public String getImageUrl(MultipartFile file) throws IOException {
		...
		Storage storage = StorageOptions.newBuilder().setProjectId("testpragyabackendapi")
		...
		HashMap<String, String> hm = new HashMap<>();
   	    ...
   	    BlobId blobId = BlobId.of("testpragyabackendapi.appspot.com",file.getOriginalFilename());
	    ...
	    String imageUrl = "https://firebasestorage.googleapis.com/v0/b/testpragyabackendapi.appspot.com/o/"+convertedFile+"?alt=media&token=3434434343434dfdf";
	    return imageUrl;
	}
}
